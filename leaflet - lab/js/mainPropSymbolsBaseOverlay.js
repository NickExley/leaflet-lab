//create function to build the sequence slider bar on map 
function createSequenceControls(map,attributes){
	...
	//adds the built sequence bar onto the map 
	...
	$('.skip').click(function(){
		...
		//calls the update prop symbols function with every click of the slider 
		updatePropSymbols(map, attributes[index]);
		//calls the update legend function with every click of the slider 
    ...
    $('.range-slider').on('input', function(){
        ...
        var index = $(this).val();
		//Step 9: pass new attribute to update symbols & legend 
		updatePropSymbols(map, attributes[index]);
		updateLegend(map, attributes[index]);
...
//create featLayer global variable
var featLayer;
...
//create function to build components of the legend
function createLegend(map, attributes){
	...
	//add function to update the legend by with each click when added to the map 
...
//create basemap and satellite global variables to be used in overlay 
var  basemap;
var satellite;
...
function createMap(){
   ...
   attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap contributors</a>'}).addTo(map);
	...
	//add a satellite image base tilelayer 
...
//create layerControl function to add radio buttons to the map to switch between basemap layers 
